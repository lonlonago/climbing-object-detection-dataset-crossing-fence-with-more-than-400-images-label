# Climbing object detection dataset (crossing fence) with more than 400 images labeled and supports v.

# Body

Climbing Object Detection Dataset (Crossing Fence) - More than 400 images, with annotations, supports VOC and YOLOF formats. Suitable for projects such as motion capture, action analysis, AI recognition, etc. The data is complete and ready to use, saving time and effort
